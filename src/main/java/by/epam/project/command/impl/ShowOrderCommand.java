...
public class ShowOrderCommand implements Command {
    ...
    private static final String EXHIBITION_ORDER = "exhibitionOrders";
    private static final String CONCERT_ORDER = "concertOrders";
    private static final String THEATRE_ORDER = "theatreOrders";
    private static final String OPERA_ORDER = "operaOrders";
    private static final String BALLET_ORDER = "balletOrders";
    private static final String CINEMA_ORDER = "cinemaOrders";
    private static final String SPORT_ORDER = "sportOrders";
